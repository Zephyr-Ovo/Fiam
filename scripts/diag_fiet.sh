...
echo "===TODO==="; wc -l fiet-home/self/todo*.jsonl 2>/dev/null; head -5 fiet-home/self/todo.jsonl 2>/dev/null
...
echo "===INBOX_RECENT==="; ls -t fiet-home/inbox/ 2>/dev/null | head -5
